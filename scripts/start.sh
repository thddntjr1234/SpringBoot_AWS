...
nohup java -jar -Dspring.profiles.active=$IDLE_PROFILE -Dspring.config.location=classpath:/application.properties,classpath:/application-$IDLE_PROFILE.properties,/home/ec2-user/app/application-oauth.properties,/home/ec2-user/app/application-real-db.properties $JAR_NAME > $REPOSITORY/nohup.out 2>&1 &