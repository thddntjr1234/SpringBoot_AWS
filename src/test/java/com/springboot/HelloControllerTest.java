...
@WebMvcTest(controllers = HelloController.class) // web(spring mvc)중 컨트롤러에 집중할 수 있는 어노테이션, @Controller, @ControllerAdvice 등을 사용가능
public class HelloControllerTest {

    @Autowired // 스프링이 관리하는 빈을 주입받음
    private MockMvc mvc; // 웹API를 테스트할 떄 사용
